"""
Stock Splits Pipeline DAG for financial data processing
...
dag = DAG(
    'stock_splits_pipeline',
    default_args=default_args,
    description='Process stock splits pipeline for financial analysis',
    schedule_interval='@daily',
    catchup=False,
    tags=['reporting', 'real_time']
)
...
def load_data():
    ...
    print("Loading stock data to warehouse...")
