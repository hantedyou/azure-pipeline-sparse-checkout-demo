"""
Position Reconciliation DAG for financial data processing
...
dag = DAG(
    ...
    description='Process position reconciliation for financial analysis',
...
def load_data():
    ...
    print("Loading position data to warehouse...")
